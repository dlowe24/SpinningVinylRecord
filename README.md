...
Change the img_path variable to the location of the image file

convert.imgToVideo('Path',233) -> Second prameter controls the duration of the spinning effect

Change the audio_path variable to the location of the audio file. 
